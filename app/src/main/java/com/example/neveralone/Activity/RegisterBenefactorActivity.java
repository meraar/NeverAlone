                            ...
                            .addOnCompleteListener(RegisterBenefactorActivity.this, new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    ...
                                    if (task.isSuccessful()) {
                                        ...
                                        DatabaseReference reference_2 = database2.child("Beneficiarios");

                                        Beneficiario beneficiario = new Beneficiario(correo, nombre, apellido, dni, postalcode);
                                        beneficiario.setDireccion(direccion + "," + PisoPuerta);
                                        reference_2.setValue(beneficiario);
