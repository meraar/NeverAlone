...
public class AutotestFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        q7 = root.findViewById(R.id.q7);
        q71 = root.findViewById(R.id.q71);

        btntest8Si = root.findViewById(R.id.btntest8Si);
        btntest8No = root.findViewById(R.id.btntest8No);
        q8 = root.findViewById(R.id.q8);

        btntest9Si = root.findViewById(R.id.btntest9Si);
        btntest9No = root.findViewById(R.id.btntest9No);
        q9 = root.findViewById(R.id.q9);

        btntest10Si = root.findViewById(R.id.btntest10Si);
        btntest10No = root.findViewById(R.id.btntest10No);
        q10 = root.findViewById(R.id.q10);

        btntest11Si = root.findViewById(R.id.btntest11Si);
        btntest11No = root.findViewById(R.id.btntest11No);
        q11 = root.findViewById(R.id.q11);

        btntest12Si = root.findViewById(R.id.btntest12Si);
